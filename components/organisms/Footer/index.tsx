                        ...
                        <div className="row gap-sm-0">
                            <div className="col-md-4 col-6 mb-lg-0 mb-25">
                                ...
                                <ul className="list-unstyled">
                                    <FooterItem title="About Us" direct="#" />
                                    <FooterItem title="Press Release" direct="#" />
                                    <FooterItem title="Terms of Use" direct="#" />
                                    <FooterItem title="Privacy & Policy" direct="#" />
                                </ul>
                            </div>
                            <div className="col-md-4 col-6 mb-lg-0 mb-25">
                                <p className="text-lg fw-semibold color-palette-1 mb-12">Support</p>
                                <ul className="list-unstyled">
                                    <FooterItem title="Refund Policy" direct="#" />
                                    <FooterItem title="Unlock Rewards" direct="#" />
                                    <FooterItem title="Live Chatting" direct="#" />
                                </ul>
                            </div>
                            <div className="col-md-4 col-12 mt-lg-0 mt-md-0 mt-25">
                                <p className="text-lg fw-semibold color-palette-1 mb-12">Connect</p>
                                <ul className="list-unstyled">
                                    <FooterItem title="hi@store.gg" direct="mailto: hi@store.gg" />
                                    <FooterItem title="eam@store.gg" direct="mailto: team@store.gg" />
                                    <FooterItem title="Pasific 12, Jakarta Selatan" direct="http://maps.google.com/?q=Pasific 12, Jakarta Selatan" />
                                    <FooterItem title="021 - 1122 - 9090" direct="tel: 02111229090" />
                                </ul>
                            </div>
                        </div>
                    </div>
